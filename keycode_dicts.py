...
keycode2description = {
    ...
    222: "Used for miscellaneous characters; it can vary by keyboard.For the US standard keyboard, "
    ...
    229: "IME PROCESS key",
    230: "OEM specific",
    231: "Used to pass Unicode characters as if they were keystrokes. The VK_PACKET key is the low word of a 32-bit "
...
description2keycode = {
    ...
    "the 'single-quote/double-quote' key": 222,
    ...
    "Virtual Key value used for non-keyboard input methods. For more information, see Remark in *KEYBDINPUT*, "
    "*SendInput*, *WM_KEYDOWN*, and *WM_KEYUP*": 231,
    "Unassigned": 232,
    "Attn key": 246,
    "CrSel key": 247,
    "ExSel key": 248,
